// generate events
var eventDates = {}
let day1 = formatDate(new Date(new Date().setDate(new Date().getDate() + 3)))
eventDates[day1] = [
  'Jazz Evening, City library 19:00',
]
let day2 = formatDate(new Date(new Date().setDate(new Date().getDate() + 40)))
eventDates[day2] = [
  'Chess club meeting, City hall 16:00',
]
let day3 = formatDate(new Date(new Date().setDate(new Date().getDate() + 12)))
eventDates[day3] = [
  'Swam lake, Theater 18:00',
  ]
